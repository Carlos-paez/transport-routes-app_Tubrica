...
L.control.layers({ "Mapa de Calles": mapaCalle, "Satélite": satelitePuro, "Vista Híbrida": mapaHibrido }, null, { position: 'topright', collapsed: false }).addTo(map);
...
window.toggleAllOmega = (show) => document.querySelectorAll(".omega-item input").forEach((chk, i) => { chk.checked = show; toggleOmegaLayer(i, show); });
